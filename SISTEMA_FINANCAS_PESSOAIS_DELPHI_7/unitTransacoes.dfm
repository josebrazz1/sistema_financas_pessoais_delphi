object formCadTransacao: TformCadTransacao
  Left = 177
  Top = 64
  ...
  object mskDataFinal: TMaskEdit
    ...
    TabOrder = 12
    Text = '  /  /    '
    OnChange = mskDataFinalChange
  end
  object rdCcr: TRadioButton
    Left = 575
    Top = 16
    Width = 129
    Height = 17
  ...
  object rdDespesaFixa: TRadioButton
    Left = 455
    Top = 16
    Width = 106
    Height = 17
    ...
    ParentFont = False
    TabOrder = 22
    OnClick = rdDespesaFixaClick
  end
  object txtParcelas: TLabeledEdit
    Left = 575
    Top = 56
    Width = 129
    Height = 22
    ...
    EditLabel.Width = 128
    EditLabel.Height = 16
    EditLabel.Caption = 'N'#250'mero de parcelas'
  ...
  object labelMsgCcr: TStaticText
    Left = 176
    Top = 176
    Width = 316
    Height = 20
    Caption = '* Obs: Insira o valor da parcela, n'#227'o o valor total.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clRed
    Font.Height = -13
    Font.Name = 'Arial'
